package io.lenur.spring.guides.uploading.files.storage.impl;
...
public class StorageServiceImpl implements StorageService {
    ...
    public StorageServiceImpl(StorageProperties properties) {
        this.uploadDirectory = Paths.get(properties.getUploadFolder());
    }
    ...
    public Stream<Path> loadAll() {
        try {
            return Files.walk(this.uploadDirectory, 1)
                    .filter(path -> !path.equals(this.uploadDirectory))
